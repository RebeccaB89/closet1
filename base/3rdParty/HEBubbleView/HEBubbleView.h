...
@interface HEBubbleView : UIScrollView <HEBubbleViewItemDelegate>
{
    ...
    CGFloat _firstItemPadding;                          // Added from AI Rebecca
    CGFloat itemBottomPadding;                          // Added from AI Rebecca
    CGFloat itemPadding;                                // space between items (vertical)
    CGFloat rightPaddingImage;                           // Added from AI Rebecca
...
@property (nonatomic, assign) CGFloat firstItemPadding; // Added from AI Rebecca
@property (nonatomic, assign) CGFloat itemBottomPadding; // Added from AI Rebecca
@property (nonatomic, assign) CGFloat itemPadding;
@property (nonatomic, assign) CGFloat rightPaddingImage; // Added from AI Rebecca
...
- (BOOL)containItem:(id)item;           // Added from AI Rebecca
