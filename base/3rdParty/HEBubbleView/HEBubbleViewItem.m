...
#define DEFAULT_BORDER_COLOR [UIColor clearColor]
#define DEFAULT_SELECTED_BORDER_COLOR [UIColor clearColor]

#define DEFAULT_BORDER_WIDTH 0.0;
#define DEFAULT_FONT [UIFont fontWithName:@"Helvetica-Bold" size:14]

#define ITEM_TEXTLABELPADDING_LEFT_AND_RIGHT 7.0;
...
@synthesize setUnselectedBorder;
...
- (void)awakeFromNib
{
    ...
    reuseIdentifier = BUBBLE_ITEM_REUSEIDENTIFIER;
